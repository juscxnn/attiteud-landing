...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    hero_desc: "Seasoned builders who ship. We use AI to accelerate development. Product design, branding, and CRO by Humbl Design. One team, one price.",
    hero_subtitle: "Your idea, shipped. We build MVPs. Humbl Design handles product design, branding, and CRO. One team, one price.",
    ...
    clients_heading: "We have done this before",
    ...
    partnership_subtitle: "We build the product. Humbl Design handles product design, branding, landing pages, and CRO. One team, one price.",
    partnership_body: "Humbl Design is a product design studio. Landing pages, web app dashboards, brand identities, CRO audits. Shipped for 50+ founders across fintech, AI, and robotics. Clients have raised over $20M. First visuals in 72 hours. Unlimited revisions. No templates. Everything built from scratch in Figma.",
    ...
    partnership_stat_4: "Product design + CRO",
    ...
    approach_step3_text: "Deploy, test, iterate. Humbl Design delivers your brand, product design, and a landing page that converts. You go live looking like a Series A company.",
    ...
    pricing_include_4: "Humbl Design: product design, brand, landing page, CRO",
    ...
    founders_label: "Who We Are",
    founders_heading: "Two founders. One team.",
    founders_justin_name: "Justin Chua",
    founders_justin_role: "Founder, Attiteud",
    founders_justin_bio: "Builder. Built and sold multiple startups including copyscouts.com and podletter.io. Currently also building gatekeep.vc.",
    founders_david_name: "David Pokorny",
    founders_david_role: "Founder, Humbl Design",
    founders_david_bio: "Product designer. 50+ founders served across fintech, AI, and robotics. Clients have raised over $20M.",
    founders_humbl_link: "Visit Humbl Design",
  ...
  cn: {
    ...
    partnership_heading: "Attiteud x Humbl Design",
    partnership_subtitle: "我们构建产品。Humbl Design 负责产品设计、品牌、落地页和 CRO。一个团队，一个价格。",
    partnership_body: "Humbl Design 是一家产品设计工作室。落地页、Web 应用仪表盘、品牌形象、CRO 审计。已为 50+ 位金融科技、AI 和机器人领域的创始人交付。客户累计融资超 $20M。72 小时出首批方案。无限修改。不用模板。每个项目在 Figma 从零构建。",
    partnership_stat_1: "72 小时交付首批设计",
    partnership_stat_2: "服务 50+ 创始人",
    partnership_stat_3: "客户累计融资超 $20M",
    partnership_stat_4: "产品设计 + CRO",
    ...
    approach_step3_text: "部署、测试、迭代。Humbl Design 交付你的品牌、产品设计和能转化的落地页。你以 A 轮公司的形象亮相。",
    approach_step4_label: "04",
    ...
    pricing_include_4: "Humbl Design: 产品设计、品牌、落地页、CRO",
    ...
    founders_label: "我们是谁",
    founders_heading: "两位创始人。一个团队。",
    founders_justin_name: "Justin Chua",
    founders_justin_role: "Attiteud 创始人",
    founders_justin_bio: "建设者。构建并出售了多家初创公司，包括 copyscouts.com 和 podletter.io。目前也在构建 gatekeep.vc。",
    founders_david_name: "David Pokorny",
    founders_david_role: "Humbl Design 创始人",
    founders_david_bio: "产品设计师。服务 50+ 位金融科技、AI 和机器人领域的创始人。客户累计融资超 $20M。",
    founders_humbl_link: "了解 Humbl Design",
  ...
  fr: {
    ...
    clients_heading: "Nous l\'avons déjà fait",
    client_nichesim_name: "nichesim.com",
    ...
    partnership_heading: "Attiteud x Humbl Design",
    partnership_subtitle: "Nous construisons le produit. Humbl Design gère le design produit, le branding, les landing pages et le CRO. Une équipe, un prix.",
    partnership_body: "Humbl Design est un studio de design produit. Landing pages, dashboards d'applications web, identités de marque, audits CRO. Livré pour plus de 50 fondateurs en fintech, IA et robotique. Clients ont levé plus de $20M. Premières maquettes en 72h. Révisions illimitées. Aucun template. Tout est conçu from scratch dans Figma.",
    ...
    partnership_stat_4: "Design produit + CRO",
    ...
    approach_step3_text: "Déployer, tester, itérer. Humbl Design livre votre marque, le design produit, et une landing page qui convertit. Vous êtes en ligne avec l'allure d'une Série A.",
    approach_step4_label: "04",
    ...
    pricing_include_4: "Humbl Design: design produit, marque, landing page, CRO",
    ...
    founders_label: "Qui Sommes-Nous",
    founders_heading: "Deux fondateurs. Une équipe.",
    founders_justin_name: "Justin Chua",
    founders_justin_role: "Fondateur, Attiteud",
    founders_justin_bio: "Builder. A construit et vendu plusieurs startups dont copyscouts.com et podletter.io. Construit actuellement gatekeep.vc.",
    founders_david_name: "David Pokorny",
    founders_david_role: "Fondateur, Humbl Design",
    founders_david_bio: "Designer produit. Plus de 50 fondateurs servis en fintech, IA et robotique. Clients ont levé plus de $20M.",
    founders_humbl_link: "Visiter Humbl Design",
