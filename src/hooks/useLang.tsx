...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    cap_1_desc: "Full stack MVP development. We scope, spec, and ship working software in weeks. React, Node, Python. Whatever your stack needs.",
    cap_2_title: "AI & Automation",
    cap_2_desc: "AI assisted development. We use AI to write better code, faster. Custom agents and automations for the parts that need real intelligence.",
    cap_3_title: "Go-to-Market Engineering",
    cap_3_desc: "Launch infrastructure. Landing pages, payments, analytics, email sequences. Humbl Design handles the brand. We handle everything else.",
